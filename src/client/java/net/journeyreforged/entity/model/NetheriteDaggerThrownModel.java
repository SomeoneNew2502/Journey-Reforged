...
public class NetheriteDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "netherite_dagger_thrown"), "main");
        private ModelPart bb_main;
        public NetheriteDaggerThrownModel(ModelPart root) {
