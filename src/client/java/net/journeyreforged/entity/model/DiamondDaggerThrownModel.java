...
public class DiamondDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "diamond_dagger_thrown"), "main");
        private ModelPart bb_main;
        public DiamondDaggerThrownModel(ModelPart root) {
