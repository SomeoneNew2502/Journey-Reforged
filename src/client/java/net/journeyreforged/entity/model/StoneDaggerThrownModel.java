...
public class StoneDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "stone_dagger_thrown"), "main");
        private ModelPart bb_main;
        public StoneDaggerThrownModel(ModelPart root) {
