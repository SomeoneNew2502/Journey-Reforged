...
public class GoldenDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "golden_dagger_thrown"), "main");
        private ModelPart bb_main;
        public GoldenDaggerThrownModel(ModelPart root) {
