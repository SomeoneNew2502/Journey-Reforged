...
public class PrismarineDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "prismarine_dagger_thrown"), "main");
        private ModelPart bb_main;
        public PrismarineDaggerThrownModel(ModelPart root) {
