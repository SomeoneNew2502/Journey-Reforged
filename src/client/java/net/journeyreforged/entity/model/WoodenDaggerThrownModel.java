...
public class WoodenDaggerThrownModel extends EntityModel<ThrowableDaggerEntity> {
        public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier("journeyreforged", "wooden_dagger_thrown"), "main");
        private ModelPart bb_main;
        public WoodenDaggerThrownModel(ModelPart root) {
