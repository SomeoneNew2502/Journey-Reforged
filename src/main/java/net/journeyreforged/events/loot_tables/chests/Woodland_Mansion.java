        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (WOODLAND_MANSION.equals(id)) {
                LootPool pool = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(Items.EMERALD).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f,5.0f))).weight(4).build())
                    ...
                    .with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f,4.0f))).apply(SetPotionLootFunction.builder(Potions.HARMING)).weight(2).build())
                ...
                LootPool pool3 = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(Items.IRON_AXE).apply(EnchantRandomlyLootFunction.builder()).weight(15).build()) //Randomly enchants the item (Allows treasure enchantments)
                    .with(ItemEntry.builder(Items.CROSSBOW).apply(EnchantRandomlyLootFunction.builder()).weight(15).build())
                    .with(ItemEntry.builder(Items.FLINT_AND_STEEL).weight(15).build())
                    .with(ItemEntry.builder(Items.SADDLE).weight(15).build())
                    .with(ItemEntry.builder(Items.IRON_SWORD).apply(EnchantRandomlyLootFunction.builder()).weight(15).build())
                    ...
                    .with(ItemEntry.builder(Items.DIAMOND_PICKAXE).apply(EnchantRandomlyLootFunction.builder()).weight(1).build())
