        ...
        LootTableEvents.REPLACE.register((resourceManager, lootManager, id, original, source) -> {
            if (ABANDONED_MINESHAFT.equals(id)) {
                ...
                LootPool pool3 = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(Items.IRON_PICKAXE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))).weight(5).build())
                    .with(ItemEntry.builder(Items.IRON_SHOVEL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))).weight(5).build())
                    .with(ItemEntry.builder(Items.IRON_PICKAXE).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))).apply(new EnchantWithLevelsLootFunction.Builder(UniformLootNumberProvider.create(1, 21))).weight(1).build())
                    .with(ItemEntry.builder(Items.IRON_SHOVEL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))).apply(new EnchantWithLevelsLootFunction.Builder(UniformLootNumberProvider.create(1, 21))).weight(1).build())
