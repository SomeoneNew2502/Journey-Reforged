        ...
        LootTableEvents.MODIFY.register((resourceManager, manager, id, supplier, setter) -> {
            if (UNDERWATER_RUIN_BIG.equals(id)) {
                LootPool pool = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(ItemRegistry.PEARL).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 3.0f))).build())
        ...
        LootTableEvents.MODIFY.register((resourceManager, manager, id, supplier, setter) -> {
            if (UNDERWATER_RUIN_SMALL.equals(id)) {
                LootPool pool = LootPool.builder()
                    ...
                    .with(ItemEntry.builder(ItemRegistry.PEARL).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 2.0f))).build())
                    .build();
                    supplier.pool(pool).build();
            }
        });
